...
from binary_converter import float2bit, bit2float, integer2bit, bit2integer
...
def make_SA2(weights, mask, mask1):
    ...
    conv_binary = integer2bit(weights, num_e_bits=8, num_m_bits=23, bias=127.)
  ...
  ## Inject errors
    ...
    float_tensor = bit2integer(output, num_e_bits=8, num_m_bits=23, bias=127.)
    return float_tensor
...
def create_mask(weight_shape, error_rate, num_bits):
    shape_list = [*weight_shape, num_bits]
